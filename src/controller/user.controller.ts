...
export async function verifyUserHandler (req: Request<VerifyUserInput>, res: Response) {
  ...
  //check to see if they are already verfified
  if(!user){
  ...
  return res.send("Could not verify user --idk what happened")
}
...
export async function resetPasswordhandler(req: Request<ResetPasswordInput['params'],{},ResetPasswordInput['body']>, res:Response) {
  ...
  //we donot need to hash because we have pre save hook @pre
